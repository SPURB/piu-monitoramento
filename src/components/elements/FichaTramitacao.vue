...
export default {
    ...
    props: {
		...
		computed: {
			periodo () {
				const inicio = typeof(this.dataTramitacao.registroSeiPrimeiro) === 'number'
					? this.formatDataExcel(this.dataTramitacao.registroSeiPrimeiro)
					: this.dataTramitacao.registroSeiPrimeiro

				const fim = typeof(this.dataTramitacao.registroSeiUltimo) === 'number'
					? this.formatDataExcel(this.dataTramitacao.registroSeiUltimo)
					: this.dataTramitacao.registroSeiUltimo
